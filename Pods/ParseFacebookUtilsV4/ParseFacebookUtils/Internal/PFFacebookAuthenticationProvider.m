...
+ (FBSDKAccessToken *)_facebookAccessTokenFromUserAuthenticationData:(nullable NSDictionary <NSString *,NSString *> *)authData {
...
- (BFTask *)authenticateAsyncWithReadPermissions:(nullable NSArray <NSString *> *)readPermissions
